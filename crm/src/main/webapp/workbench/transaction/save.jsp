	...
	<script type="text/javascript">
		...
		/*
			...
			关于阶段和可能性
				是一种一一对应的关系
				一个阶段对应一个可能性
				我们现在可以将阶段和可能性想象成是一种键值对的对应关系
				以阶段为key  通过选中key，触发可能性value
		...
		$(function () {
			...
			// 为阶段的下拉框，绑定下拉框选中事件，根据选中的阶段填写可能性
			...
			$("#create-stage").change(function () {
				...
				/*
					...
					目标：填写可能性
						阶段有了stage
						阶段和可能性之间的对应关系pMap,但是pMap是java中的键值对关系
				...
				/*
					不能以json.key的形式取得value

					stage是一个可变的变量

					如果是这样的key，不能以传统的形式来取值
					json[key]
				 */
...
<body>
	...
	<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-possibility" value="" readonly>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="2562dfd6d65641fdbf31604e3c0697a8" name="activityId">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="e23c8da76fad48dc8aa6ade99661b8b3" name="contactsId">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 70%;">
				<textarea class="form-control" rows="3" id="create-describe" name="decription"></textarea>
			</div>
		</div>
